...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:t3theme/Resources/Private/Language/locallang_t3theme.xlf:tx_t3theme_domain_model_elements',
        'label' => 'data',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'versioningWS' => true,
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_t3theme_domain_model_elements',
                'foreign_table_where' => 'AND {#tx_t3theme_domain_model_elements}.{#pid}=###CURRENT_PID### AND {#tx_t3theme_domain_model_elements}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
